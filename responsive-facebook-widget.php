<?php
/**
 * @package Responsive Facebook Page Widget
*/
/*
Plugin Name: Responsive Facebook Page Widget
Plugin URI: http://www.sparxstudios.com
Description: Facebook Latest Version 2.8 based widget. Thanks for installing Responsive Facebook Page Widget.
Version: 1.0
Author: sparxstudios
Author URI: http://www.sparxstudios.com
*/

class ResponsiveFacebookPageWidget extends WP_Widget{
    
    public function __construct() {
        $params = array(
            'description' => 'Facebook Latest Version 2.8 based widget. Thanks for installing Responsive Facebook Page Widget.',
            'name' => 'Responsive Facebook Page Widget'
        );
        parent::__construct('ResponsiveFacebookPageWidget','',$params);
    }
...
add_action('widgets_init','register_ResponsiveFacebookPageWidget');
function register_ResponsiveFacebookPageWidget(){
    register_widget('ResponsiveFacebookPageWidget');
}
